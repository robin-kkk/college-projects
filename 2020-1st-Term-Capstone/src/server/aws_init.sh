...
echo "alias svc=\"docker service\"" >> ~/.bash_aliases
echo "alias ds=\"docker stack\"" >> ~/.bash_aliases
echo "alias dv=\"docker volume\"" >> ~/.bash_aliases
echo "alias dn=\"docker network\"" >> ~/.bash_aliases
echo "alias dm=\"docker-machine\"" >> ~/.bash_aliases
